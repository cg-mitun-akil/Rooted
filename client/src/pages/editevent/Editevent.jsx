...
const Editevent = () => {
  ...
  <div className="addevent">
    ...
    <Grid container spacing={2} >
      ...
      <Grid container spacing={2}>
        ...
        <Autocomplete
                onChange={(event, newValue) => {
                    setContactCountryCode(newValue.phone);
                }}
      ...
      <div className="addimg">
      <Grid container spacing={2}>
        <Grid item xs={12} className="input1">
            {!image && 
                <IconButton color="primary" aria-label="upload picture" component="label">
                    <input hidden accept="image/*" type="file" onChange={handleImageChange} />
                    <PhotoCamera style={{ color: 'brown' }} />
                </IconButton>}
            {image && <img src={URL.createObjectURL(image)} alt="Uploaded Image" style={{ maxWidth: '100%', height: 'auto' }} />}
        </Grid>
        <Grid item xs={5}  >
        ...
        <Grid item xs={5}  >
            <button type="submit" onClick={handleUploadVideo}>Upload Video</button>
        </Grid>
        ...
        <Grid item xs={5}>
            <button type="submit" onClick={handleAddDate}>Add Date</button>
        </Grid>
        <Grid item xs={5}>
            <button type="submit" onClick={handleDeleteDate}>Remove Date</button>
        </Grid>
      </Grid>
      </div>
      <br />
